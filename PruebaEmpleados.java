...
public class PruebaEmpleados {
	...
	public static String actividadParticular(Planta a){	
		 ...
		 */
                if(a instanceof Directivo){
                    Directivo x = (Directivo)a;
                    return x.administrar() + "\n" + x.definirAumentos() + "\n" + x.reportarLogros();
                }
                if(a instanceof Secretaria){
                    Secretaria y = (Secretaria)a;
                    return y.llenaRegistros();
                }
		return null;
	}
	...
	public static String queHace(Administrativo d){
		...
		if(d instanceof Directivo){
                    Directivo s = (Directivo)d;
                    return s.administrar() + "\n" + s.definirAumentos() + "\n" + s.reportarLogros();
                }
                if(d instanceof Secretaria){
                    Secretaria l = (Secretaria)d;
                    return l.llenaRegistros();
                }
		return null;
	}
}